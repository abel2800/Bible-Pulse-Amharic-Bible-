...
public class FlutterLocalNotificationsPlugin
  ...
  private static void setBigPictureStyle(
    ...
    if (bigPictureStyleInformation.hideExpandedLargeIcon) {
      // disambiguate overloaded bigLargeIcon call by casting null to Bitmap to select the
      // Bitmap overload (resolves compilation ambiguity with newer support libs)
